 ...
 * @e_ident: this points to the array that contains the ELF numbers
 *
 * Note: Exit code 8 is used if the file is not an ELF file
 */
void check_elf(unsigned char *e_ident)
{
	int index;
 ...
 * @e_ident: points to the array that contains the ELF magic numbers
...
/**
 * print_data - data of the ELF header
 ...
 * @e_ident - points to the array containing the ELF version
 */
void print_version(unsigned char *e_ident)
{
	printf(" Version: %d",
 ...
 * @e_ident - points to the array that contains the ELF version
 */
void print_osabi(unsigned char *e_ident)
{
	printf(" OS/ABI: ");
...
/**
 * print_abi - ABI version of the ELF header
...
/**
 * print_entry - displays entry point of the ELF header
...
/**
 * main - shows information contained in the ELF header 
